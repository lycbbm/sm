...
public class Test {
    ...
    public static boolean verify(String summary,String sign, String pubk) {
        boolean vs = false;
        try {
            vs = SM2Utils.verifySign("master test test test".getBytes(), Util.hexToByte(pubk),Util.hexToByte(summary), Util.hexToByte(sign));
            System.out.println("master test test test");
